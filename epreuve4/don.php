...
<html>
	...
	<body>
		...
		<div class="wrapper wrapper_big" data-epreuve="6">
			<div class="top">
				<input type="text" name="name_top">
				<button class="validate validate_top">Valider</button>
			</div>

			<div class="left"></div>
			<div class="supernem">
				<img src="../img/planch16.jpg" alt="">
			</div>
			<div class="right"></div>

			<div class="bottom">
				<input type="text" name="name_bottom">
				<button class="validate validate_bottom">Valider</button>
			</div>
		</div>
